        ...
        <div className="w-full max-w-md">
          <div className="glass-panel rounded-[2rem] p-10 md:p-12 border border-white/30 shadow-[0_20px_60px_rgba(138,90,43,0.15)]">
            <div className="space-y-2 mb-8">
              ...
              <p className="text-sm text-[#6B625B]">请输入您的凭据以访问智能日志分析系统</p>
            </div>

            <form action={signInAction} className="space-y-6">
              <div className="space-y-4">
                <div className="space-y-2">
                  <label className="text-xs uppercase tracking-widest font-label text-[#6B625B] ml-1">电子邮箱 / 用户名</label>
                  <div className="relative">
                    <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-[#6B625B]">person</span>
                    <input
                      name="email"
                      type="email"
                      className="w-full rounded-xl py-4 pl-12 pr-4 bg-[#EFE4D2] border border-transparent focus:border-[#8A5A2B]/40 focus:ring-0 outline-none"
            ...
            <div className="mt-8 text-center text-sm text-[#6B625B]">
              <Link href="/auth/reset-password" className="hover:text-[#8A5A2B] transition">忘记密码</Link>
              <span className="mx-3">|</span>
              <Link href="/register" className="font-semibold hover:text-[#8A5A2B] transition">立即注册</Link>
            </div>
          </div>
        </div>
      </main>
